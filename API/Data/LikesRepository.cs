...
public class LikesRepository(DataContext context, IMapper mapper) : ILikesRepository
{
    ...
    public async Task<UserLike?> GetUserLike(int soutceUserId, int targetUserId)
        => await context.Likes.FindAsync(soutceUserId, targetUserId);
